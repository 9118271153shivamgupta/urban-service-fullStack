...
const SuperAdminDashboard = () => {
  ...
  return (
    <div className="flex h-screen w-screen bg-[#000b21] text-white font-['Poppins'] overflow-hidden relative">
...
// // Naye components import (Path Fixed Here 🎯)
// import AllAdminsList from './AllAdminsList';
// import AllProvidersList from './AllProvidersList';
// import ServiceBookingList from './ServiceBookingList'; // Fixed file name to match exactly
...
//             {/* Dynamic Rendering (Tab IDs Synced Cleanly 🚀) */}
//             {activeTab === 'Admins' && <AllAdminsList />}
//             {activeTab === 'Providers' && <AllProvidersList />}
//             {activeTab === 'bookings' && <ServiceBookingList />} {/* Changed from 'Booking' to 'bookings' */}
